# Generated by Django 5.0.1 on 2024-01-19 00:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_company', models.BooleanField(default=False, help_text='Designates whether this user is a company account.')),
                ('company_name', models.CharField(blank=True, help_text='The legal name of the company.', max_length=255, null=True)),
                ('registration_number', models.CharField(blank=True, help_text='The official registration number of the company.', max_length=50, null=True)),
